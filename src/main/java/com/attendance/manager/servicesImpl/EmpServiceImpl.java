...
public class EmpServiceImpl implements EmpService {
	...
	public Employee saveEmplyee(Employee employee) {
		if(employee.getEmail() == null) {
			log.error("saveEmplyee Email id not Empty");
	...
	public Employee updateEmployee(int id, Employee employee) {
		...
		if (emp.getId() == id) {
			...
			log.error("updateEmployee record not found ",id);
	...
	public List<Employee> findByEmployeeName(String employeeName) {
		...
		if(CollectionUtils.isEmpty(allEmp)) {
			log.error("findByEmployeeName record not found ",employeeName);
	...
	public List<Employee> findByEmployeeNameStartingWith(String startingName) {
		...
		if (allEmp.isEmpty()) {
			log.error("findByEmployeeNameStartingWith record not found ",startingName);
